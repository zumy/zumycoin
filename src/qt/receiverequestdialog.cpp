...
#include "config/zumy-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatZumyURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ZumyUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatZumyURI(info));
}
