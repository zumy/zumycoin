...
/** Zumy unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZumyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZumyUnits(QObject *parent);
...
typedef ZumyUnits::Unit ZumyUnit;
