...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle):
        QAbstractItemDelegate(), unit(ZumyUnits::ZMY),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = ZumyUnits::floorWithUnit(unit, amount, true, ZumyUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, ZumyUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, ZumyUnits::separatorAlways));
    ui->labelImmature->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, ZumyUnits::separatorAlways));
    ui->labelAnonymized->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, ZumyUnits::separatorAlways));
    ui->labelTotal->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, ZumyUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, ZumyUnits::separatorAlways));
    ui->labelWatchPending->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, ZumyUnits::separatorAlways));
    ui->labelWatchImmature->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, ZumyUnits::separatorAlways));
    ui->labelWatchTotal->setText(ZumyUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ZumyUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("ZMY")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = ZumyUnits::formatHtmlWithUnit(nDisplayUnit, nPrivateSendAmount * COIN, false, ZumyUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), ZumyUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = ZumyUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, ZumyUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), ZumyUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(ZumyUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(ZumyUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
