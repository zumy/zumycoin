...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", ZumyUnits::ZMY);
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizeZumyAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizeZumyAmount").toInt());
    }
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in zumy.cpp during shotdown to also remove the window positions
