...
// Zumy : to ensure that we can click on lock icon in GUI
...
/**
  Zumy GUI main class. This class represents the main window of the Zumy UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ZumyGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ZumyGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ZumyGUI();
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with zumy.conf */
    void showConfEditor();
