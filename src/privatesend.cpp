...
{
    if(fLiteMode) return; // ignore all Zumy related functionality
...
void CPrivatesendPool::InitDenominations()
{
    ...
    /* Denominations
        ...
        For example:
        1ZMY+1000 == (.1ZMY+100)*10
        10ZMY+10000 == (1ZMY+1000)*10
    */
...
/*
    ...
    adds up to a cost of 0.001 ZMY per transaction on average.
*/
