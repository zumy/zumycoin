...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Zumy features */
    { "Zumy",                "masternode",                 &masternode,                 true  },
    { "Zumy",                "masternodelist",             &masternodelist,             true  },
    { "Zumy",                "masternodebroadcast",        &masternodebroadcast,        true  },
    { "Zumy",                "gobject",                &gobject,                true  },
    { "Zumy",                "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "Zumy",                "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "Zumy",                "voteraw",                &voteraw,                true  },
    { "Zumy",                "mnsync",                 &mnsync,                 true  },
    { "Zumy",                "spork",                  &spork,                  true  },
    { "Zumy",                "getpoolinfo",            &getpoolinfo,            true  },
#ifdef ENABLE_WALLET
    { "Zumy",                "privatesend",            &privatesend,            false },
...
{
    return "> zumy-cli " + methodname + " " + args + "\n";
}
