...
public:
    ...
    size_t ZumyMemoryUsage() const { return nUsageSize; }
...
private:
    ...
    uint64_t cachedInnerUsage; //! sum of zumy memory usage of all the map elements (NOT the maps themselves)
...
public:
    ...
    /** Remove transactions from the mempool until its zumy size is <= sizelimit.
