...
//
// The Masternode Class. For managing the Privatesend process. It contains the input of the 1000ZMY, signature to prove
...
public:
    ...
    /// Is the input associated with this public key? (and there is 500 ZMY (5,000 after fork) - checking if valid Masternode)
